...
import os
import sys
BASE_DIR = "/home/tione/notebook/wbdc2021"
user_action_path = os.path.join(BASE_DIR,'data/wedata/wechat_algo_data2/user_action.csv')
feed_info_path = os.path.join(BASE_DIR, 'data/wedata/wechat_algo_data2/feed_info.csv')
feed_embeddings_path = os.path.join(BASE_DIR,'data/wedata/wechat_algo_data2/feed_embeddings.csv')
test_data_path = os.path.join(BASE_DIR,'data/wedata/wechat_algo_data2/test_a.csv')
feed_info_frt_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/feed_info_frt.csv'

feed_embeddings_PCA_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/feed_embeddings_PCA.csv'
feed_info_manual_key_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/feed_info_manual_key.csv'
feed_info_manual_tag_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/feed_info_manual_tag.csv'
feed_info_manual_tag_sta_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/feed_info_manual_tag_sta.csv'

model_root_path = '/home/tione/notebook/master_wang/wbdc2021-preliminary/src/src_ctb/model'
        ...
        for line in file[key]:
            ...
            if line!="nan":
                for one in line.split(";"):
                    a+=one+" "
        with open('/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/' + str(key)+".txt","w") as f:
            f.write(a)
        sentences =word2vec.Text8Corpus('/home/tione/notebook/master_wang/wbdc2021-preliminary/data/generated_data/data_ctb/' + str(key)+".txt") # 加载语料
...
UM_EPOCH_DICT = {"read_comment": 0.3, "like": 0.3, "click_avatar": 0.3,"forward": 0.3,
                                "comment": 0.3, "follow": 0.3, "favorite": 0.3, }
...
#     print(weighted_uauc)
    ...
    for yy in range(1):
        ...
        clf.save_model('model_' + str(y) + '.txt')
    ...
    #
    #     '%s_sub_%.6f_%.6f_%.6f_%.6f_%.6f.csv' % (yy,weighted_uauc, uauc_list[0], uauc_list[1], uauc_list[2], uauc_list[3]),
    #
    #     index=False
    #
    # )
    #return test[y],uauc_list
